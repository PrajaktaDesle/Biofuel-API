...
//     try{
//         let estimate = await estimateService.fetchAllProducts( req )
//         if ( estimate instanceof Error ){
//            return apiResponse.error( res,
//                                     httpStatusCodes.BAD_REQUEST,
//                                     estimate.message )
...
//     try{
//         let estimate = await estimateService.fetchAllProductCategories(  )
//         if ( estimate instanceof Error ){
//            return apiResponse.error( res,
//                                     httpStatusCodes.BAD_REQUEST,
//                                     estimate.message )
...
//     try{
//         let estimate = await estimateService.updateProductById( req )
//         if ( estimate instanceof Error ){
//            return apiResponse.error( res,
//                                     httpStatusCodes.BAD_REQUEST,
//                                     estimate.message )
...
//     try{
//         let estimate = await estimateService.fetchAllProductUsageUnits(  )
//         if ( estimate instanceof Error ){
//            return apiResponse.error( res,
//                                     httpStatusCodes.BAD_REQUEST,
//                                     estimate.message )
...
//     try{
//         let estimate = await estimateService.updateProductStatus( req.body )
//         if ( estimate instanceof Error ){
//            return apiResponse.error( res,
//                                     httpStatusCodes.BAD_REQUEST,
//                                     estimate.message )
