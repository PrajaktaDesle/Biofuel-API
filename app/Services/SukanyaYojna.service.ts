...
async function fetchSukanyaByCustomerId(customer_id: any, tenant_id: any) {
    try {
    //     console.log("customer_id :", customer_id, "tenant-id:", tenant_id);
    //     let sukanyaYojnaList = await new SukanyaYojnaModel().fetchSukanyaByCustomerId(customer_id, tenant_id);
