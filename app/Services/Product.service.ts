...
const updateProductById = async (req: any) => {
    ...
    try {
        ...
        if (fields.hsn !== undefined && fields.hsn !== null && fields.hsn !== "")
            product.hsn = fields.hsn;
        if (fields.weight !== undefined && fields.weight !== null && fields.weight !== "")
            product.weight = fields.weight;
        if (fields.pack_size !== undefined && fields.pack_size !== null && fields.pack_size !== "")
            product.pack_size = fields.pack_size;
        if (fields.grade !== undefined && fields.grade !== null && fields.grade !== "")
            product.grade = fields.grade;
        if (fields.rm !== undefined && fields.rm !== null && fields.rm !== "")
            product.rm = fields.rm;
        if (fields.gcv !== undefined && fields.gcv !== null && fields.gcv !== "")
            product.gcv = fields.gcv;
        if (fields.ash !== undefined && fields.ash !== null && fields.ash !== "")
            product.ash = fields.ash;
        if (fields.moisture !== undefined && fields.moisture !== null && fields.moisture !== "")
            product.moisture = fields.moisture;
